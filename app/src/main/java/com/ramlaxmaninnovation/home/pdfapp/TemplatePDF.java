...
public class TemplatePDF {
    ...
    private Font fTitle = new Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 16, BOLD);
    private Font fSubTitle = new Font(com.itextpdf.text.Font.FontFamily.TIMES_ROMAN, 16, BOLD);
    private Font fText = new Font(Font.FontFamily.TIMES_ROMAN, 12, BOLD);
    private Font fHighText = new Font(Font.FontFamily.TIMES_ROMAN, 15, BOLD, BaseColor.RED);
    private Font fTotalValue = new Font(Font.FontFamily.TIMES_ROMAN, 22, BOLD, BaseColor.BLACK);
    ...
    public void viewPDF(Activity activity){
        ...
        if(pdfFile != null && pdfFile.exists()){
            ...
            try {
                ...
                File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "Transaction List.pdf");
